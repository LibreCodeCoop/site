  ...
  <section class="lc-section lc-section--ink">
    <div class="lc-shell">
      <div class="lc-head">
        ...
        <p><a class="lc-why__link" href="https://github.com/LibreCodeCoop/brand/releases/latest/download/librecode-brand-manual.pdf">Baixar manual da marca mais recente (PDF) <span aria-hidden="true">↓</span></a></p>
